      ...
      <motion.div initial={{ opacity:  0 }} animate={{opacity: 1 }} transition={{ opacity: { duration: 0.2 } }} exit={{ opacity: 0 }}>
         ...
         <section className = "home">
            <section className = "home-section-0">
               <div className = "home-section-0-content-0" initial={{ opacity:  0 }} animate={{opacity: 1 }} transition={{ opacity: { duration: 0.2 } }} exit={{ opacity: 0 }}>
               ...
               <div className = "home-section-0-content-1" initial={{ opacity:  0 }} animate={{opacity: 1 }} transition={{ opacity: { duration: 0.4 } }}>
